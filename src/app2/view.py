...
class FenetreAppli(QMainWindow):
    ...
    def traiter_recherche_magasin(self, nom_magasin):
        ...
        chemin_complet = os.path.join(os.path.dirname(__file__), "..", "app1", "listes_produits_entreprise", f"{fichier}")
        ...
        self.__chemin = os.path.join(os.path.dirname(__file__), "..", "..", "images", "plan_magasin.jpg")
        self.affiche_image()
    ...
    def creer_liste_course(self):
        ...
        bouton_afficher_tous = QPushButton("Afficher le chemin")
